...
const Payment = () => {
  ...
  useEffect(() => {
    if (location?.state) {
      ...
      console.log('the amount for the post is', location.state.price)
      // setTitle(Array.isArray(location.state.product) ? "Products" : location.state.product);
      if (Array.isArray(location.state.products)) {
        setTitle("Multiple Products");
      } else {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      console.log('the data from the srever is ', data)
      ...
      toast.error("Payment failed. Please try again. or Try by booking directly without adding to cart");
    } finally {
      setLoading(false);
    }
  };
      ...
      <form onSubmit={handlePayment} className="space-y-4">
        <div className="flex flex-col">
          ...
          <input
            ...
            className="p-3 border rounded-md bg-white text-gray-950"
